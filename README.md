...
**Learn how to use Forge-Std with the [📖 Foundry Book](https://getfoundry.sh/) and [Forge Repository](https://github.com/foundry-rs/foundry)(https://getfoundry.sh/reference/forge-std/overview/).**
