...
// 💬 ABOUT
// Forge Std's Script with CreateX as the default CREATE2/CREATE3 factory.
// Use this for new scripts to leverage the enhanced features of CreateX.
...
// ⭐️ SCRIPT2
/// @title Script2
/// @notice Enhanced Script contract that defaults to CreateX for deterministic deployments.
...
abstract contract Script2 is ScriptBase, StdChains, StdCheatsSafe, StdUtils {
    ...
    function deployCreate2AndInit(
        ...
        deployed =
            createX.deployCreate2AndInit{value: constructorValue + initValue}(salt, initCode, initData, ICreateX.Values(constructorValue, initValue));
    }
    ...
    function deployCreate3AndInit(
        ...
        deployed =
            createX.deployCreate3AndInit{value: constructorValue + initValue}(salt, initCode, initData, ICreateX.Values(constructorValue, initValue));
    }
